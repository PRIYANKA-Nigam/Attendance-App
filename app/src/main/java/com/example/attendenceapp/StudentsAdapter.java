...
public interface OnItemClickListener{ void onClick(int position);}
    ...
    public StudentViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new StudentViewHolder(view,onItemClickListener); }@Override
    ...
    public static class StudentViewHolder extends RecyclerView.ViewHolder {
        ...
        public StudentViewHolder(@NonNull View itemView,OnItemClickListener onItemClickListener) { super(itemView);
