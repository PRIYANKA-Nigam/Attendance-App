...
public class StudentsAdapter2 extends RecyclerView.Adapter<StudentsAdapter2.StudentViewHolder> {
    ...
    public StudentsAdapter2(Context context, ArrayList<StudentItem> arrayList) {
        this.arrayList = arrayList; this.context = context; }@NonNull  @Override
    public StudentViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.student_item2,parent,false);
